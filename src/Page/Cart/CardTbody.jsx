...
const CardTbody = ({ data, setDeleteRefetch }) => {
  ...
  const incrementCourse = () => {
    ...
    setDeleteRefetch((priv) => !priv);
  };

  // decrement Course Qty
  ...
  const handleDelete = () => {
    ...
    const cartItemsCout = JSON.parse(localStorage.getItem("cartItems")) || [];
    if (cartItemsCout.length < 1) {
      navigate("/course");
      return;
    }
  };
          ...
          <div className="flex items-center justify-center ">
            <div className="w-[20%] text-center flex items-center justify-center ">
              <button
                ...
                type="button"
                className=" transition-all p-2 rounded-full hover:bg-red-600 hover:text-white "
              >
