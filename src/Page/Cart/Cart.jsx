...
import { TotalPrice } from "../../Utils/PricesFunc/totalPriceCount";
...
const Cart = () => {
  ...
  // Data fetching Sort by card items
  useEffect(() => {
  ...
  // navigate to next Proccess
  const CheckoutCourses = () => {
    const cartItems = JSON.parse(localStorage.getItem("cartItems")) || [];
    if (cartItems.length < 1) {
      toast.warning(
        "Your cart is empty. Please add some courses before proceeding to checkout.",
        {
          position: "top-right",
          autoClose: 2000,
            ...
            <div className="px-[30px]">
              ...
              <div className="py-3 flex justify-between border-b border-gray-300">
                ...
                <p className="text-black font-bold">
                  {TotalPrice(courses) || 0} TK
                </p>
              </div>
              <button
                onClick={CheckoutCourses}
